...
describe('inquiryEmailSubject', () => {
  it('includes both name and summary', () => {
  ...
  it('falls back to a generic name when student name is whitespace', () => {
    expect(inquiryEmailSubject('   ', '')).toBe('New inquiry from A student · StudentX');
  });
});
...
describe('inquiryEmailHtml', () => {
  ...
  it('produces English HTML with the correct lang and listing URL', () => {
