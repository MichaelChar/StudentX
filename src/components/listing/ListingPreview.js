    ...
    <div className="fixed inset-0 z-[60] overflow-y-auto bg-stone">
      ...
      <div className="sticky top-0 z-10 flex items-center justify-between gap-4 border-b border-night/10 bg-blue px-5 py-3 text-white">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 shrink-0 rounded-control bg-white/15 px-3 py-1.5 text-xs font-sans font-semibold uppercase tracking-[0.08em] hover:bg-white/25 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        >
