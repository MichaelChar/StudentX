    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 z-10 flex items-center justify-between px-5 py-4 text-white">
        ...
        <button
          ...
          onClick={onClose}
          aria-label={t('close')}
          className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 active:bg-white/30 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 outline-white focus-visible:outline-white"
        >
...
function ArrowButton({ dir, label, disabled, onClick }) {
  ...
  return (
    <button
      ...
      } inline-flex items-center justify-center w-11 h-11 rounded-full bg-white/10 text-white hover:bg-white/20 active:bg-white/30 transition-colors disabled:opacity-25 focus-visible:outline-2 focus-visible:outline-offset-2 outline-white focus-visible:outline-white`}
    >
