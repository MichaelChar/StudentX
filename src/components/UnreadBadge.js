...
export default function UnreadBadge({ count, href }) {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute -top-1 -right-2 inline-flex items-center justify-center min-w-[18px] h-[18px] rounded-full bg-yellow text-white text-[10px] font-sans font-semibold px-1"
      >
        {display}
      </span>
    </Link>
