...
// at the homepages, so /en/property/results crawls inherit the wrong alternates.
const elUrl = `${SITE_URL}/property/results`;
const enUrl = `${SITE_URL}/en/property/results`;
