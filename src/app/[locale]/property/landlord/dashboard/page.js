...
export default function LandlordDashboardPage() {
  ...
  return (
    <LandlordShell
      ...
      actions={
        <>
          <Button href="/property/landlord/listings/new" variant="gold" size="sm">
            {t('quickNewListing')}
          </Button>
        </>
      }
        ...
        <section className="lg:col-span-2">
          <Card tone="white" className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link
                href="/property/landlord/listings"
            ...
            {loading ? (
              ...
              <div className="text-center py-12 border border-dashed border-night/15 rounded-sm">
                ...
                <Button href="/property/landlord/listings/new" variant="primary" size="sm">
                  {tLegacy('addFirst')}
                </Button>
              </div>
            ) : (
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <Link
          href={`/property/landlord/listings/${listing.listing_id}/edit`}
    ...
    return (
      <Card tone="parchment" className="p-6 md:p-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          ...
          <Button href="/property/landlord/verification" variant="gold" size="md">
            {t('submitIdCta')}
          </Button>
        </div>
      </Card>
    ...
    return (
      <Card tone="parchment" className="p-6 md:p-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          ...
          <Button href="/property/landlord/get-verified" variant="gold" size="md">
