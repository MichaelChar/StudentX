  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-5 pt-20 pb-12 md:pt-28 md:pb-16">
        <p className="label-caps text-night/70 mb-6">{t('eyebrow')}</p>
        <h1 className="font-display text-4xl md:text-6xl text-night leading-[1.05]">
          {t('titlePrefix')}{' '}
          <span className="italic text-blue">{t('titleItalic')}</span>
        </h1>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 md:py-20">
        <p className="label-caps text-night/70 mb-4">{t('missionEyebrow')}</p>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 md:py-24">
        <p className="label-caps text-night/70 mb-4">{t('howItWorksEyebrow')}</p>
        <h2 className="font-display text-3xl md:text-4xl text-night leading-tight max-w-2xl">
          {t('howItWorksTitle')}
        </h2>
      ...
      {/* Contact */}
      <section className="mx-auto max-w-4xl px-5 py-16 md:py-20">
        <p className="label-caps text-night/70 mb-4">{t('contactEyebrow')}</p>
