  ...
  if (notFound) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        ...
        <Link href="/results" className="inline-block bg-gold text-white font-heading font-semibold px-6 py-3 rounded-lg hover:bg-gold/90 transition-colors">
          {t('browseListings')}
        </Link>
      </div>
    );
  ...
  if (unsubscribed || (alert && !alert.is_active)) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        ...
        <Link href="/results" className="inline-block bg-navy text-white font-heading font-semibold px-6 py-3 rounded-lg hover:bg-navy/90 transition-colors">
          {t('browseListings')}
        </Link>
      </div>
    );
