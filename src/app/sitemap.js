...
export default async function sitemap() {
  // Static pages — include both EN (default, no prefix) and EL (with /el prefix)
  const staticRoutes = [
    { url: SITE_URL, lastModified: new Date(), changeFrequency: "daily", priority: 1.0 },
    { url: `${SITE_URL}/el`, lastModified: new Date(), changeFrequency: "daily", priority: 1.0 },
    { url: `${SITE_URL}/results`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
    { url: `${SITE_URL}/el/results`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
  ];
  ...
  try {
    ...
    const listingRoutes = data.flatMap((row) => [
      ...
      {
        url: `${SITE_URL}/el/listing/${row.listing_id}`,
        lastModified: new Date(row.updated_at),
        changeFrequency: "weekly",
        priority: 0.7,
      },
