...
export default async function sitemap() {
  ...
  // /property and /en/property are the multi-city hub; /property/thessaloniki
  // and /property/thessaloniki/results are the city-scoped equivalents.
  const staticRoutes = [
    ...
    { url: `${SITE_URL}/en/property/thessaloniki`, lastModified: new Date(), changeFrequency: "daily", priority: 0.95 },
    { url: `${SITE_URL}/property/thessaloniki/results`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
    { url: `${SITE_URL}/en/property/thessaloniki/results`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
  ];
  ...
  try {
    ...
    const listingRoutes = data.flatMap((row) => [
      ...
      {
        url: `${SITE_URL}/en/property/thessaloniki/listing/${row.listing_id}`,
        lastModified: new Date(row.updated_at),
        changeFrequency: "weekly",
        priority: 0.7,
      },
