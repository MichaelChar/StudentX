 ...
 *
 * The results page already fetches every matching listing client-side; these
 * functions bucket the listings' monthly prices into a fixed set of bars so a
 * compact chart can show where the current budget cut lands. Kept dependency-
 * free and side-effect-free so it's trivially unit-testable.
 */
