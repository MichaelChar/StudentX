        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#F0EBDF;border-radius:12px;overflow:hidden;border:1px solid #E5DFD0;">
          <tr>
            <td style="background:#01828D;padding:24px 32px;">
              <p style="margin:0;font-family:'Source Sans 3','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#B8860B;">${copy.eyebrow}</p>
          ...
          <tr>
            <td style="padding:32px;">
              <h1 style="margin:0 0 8px;font-family:'EB Garamond',Garamond,Georgia,'Times New Roman',serif;font-size:26px;font-weight:600;color:#01828D;letter-spacing:-0.01em;">${copy.title.replace('{rank}', foundingRank)}</h1>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;background:#01828D;border-radius:8px;">
                <tr>
