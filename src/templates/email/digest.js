...
export function digestEmailHtml({ label, listings, manageUrl, appUrl }) {
  ...
  const listingRows = listings.slice(0, 10).map((l) => {
    ...
    const listingUrl = `${appUrl}/property/thessaloniki/listing/${l.listing_id}`;

    return `
    <tr>
      <td style="padding:16px 0;border-bottom:1px solid #e6eaef;">
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="vertical-align:top;">
              <p style="margin:0 0 4px;font-family:'Source Sans 3','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:700;color:#0a2540;">${price}</p>
              ${type ? `<p style="margin:0 0 2px;font-family:'Source Sans 3','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:13px;color:#0a2540;">${type}${neighborhood ? ' · ' + neighborhood : ''}</p>` : ''}
              <a href="${listingUrl}" style="display:inline-block;margin-top:8px;font-family:'Source Sans 3','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;color:#ffcb57;text-decoration:none;">View listing →</a>
            </td>
          </tr>
        </table>
      </td>
              ...
              <table cellpadding="0" cellspacing="0" style="margin-top:24px;">
                <tr>
                  <td style="background:#0a2540;border-radius:8px;padding:0;">
                    <a href="${appUrl}/property/thessaloniki/results" style="display:inline-block;padding:12px 28px;font-family:'Source Sans 3','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;">View all results</a>
                  </td>
                </tr>
              </table>
            </td>
